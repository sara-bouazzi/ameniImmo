  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid grid-cols-1 ${user && user.role === "visiteur" ? "lg:grid-cols-3" : ""} gap-4`}>
          {/* Colonne principale */}
          <div className={`${user && user.role === "visiteur" ? "lg:col-span-2" : ""} space-y-4`}>
            {/* Images carousel */}
...
<>
          ...
          {/* Colonne latérale - Visible uniquement pour les visiteurs */}
          {user && user.role === "visiteur" && (
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center justify-center w-full bg-primary-600 hover:bg-primary-700 text-white py-3 rounded-lg font-semibold transition-colors"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href={`https://wa.me/+21656101017?text=Je suis intéressé par: ${annonce.titre}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-full bg-[#25D366] hover:bg-[#20BA5A] text-white py-3 rounded-lg font-semibold transition-colors"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center w-full bg-white border-2 border-gray-300 text-gray-700 hover:border-primary-600 hover:text-primary-600 py-3 rounded-lg font-semibold transition-all"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
